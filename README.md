...
![Скриншот формы для работы с таблицами](images/Tables.png)
...
![Скриншот формы для работы с текстом в таблицах](images/Text_in_tablest.png)
...
![Скриншот формы для очистки текста](images/Clean_text.png)
...
![Скриншот формы для работы с часто используемыми символами](images/Symbols.png)
...
![Скриншот формы для работы с текстовыми надписями](images/Text_boxes.png)
...
![Скриншот формы для работы с подсветкой символов](images/QA.png)
...
![Скриншот формы для работы с изображениями](images/Pictures.png)
...
![Скриншот формы для работы с альтернативным текстом](images/Alt_text.png)
...
![Скриншот формы для работы Font&Size Inspector](images/Font_&_color inspector.png)
